...
const DEFAULT_GRADIENT = ['#2065ab', '#4393c3', '#90c4dd', '#d1e5f0', '#f6f7f7', '#fddbc7', '#f3a481', '#d6604d', '#b1182b']; // blue-low, red-high
//const DEFAULT_GRADIENT = ['#b1182b', '#d6604d', '#f3a481', '#fddbc7', '#f6f7f7', '#d1e5f0', '#90c4dd', '#4393c3', '#2065ab']; // red-low, blue-high
...
class Hilomap extends VectorLayer {
  ...
  handleRender_(event) {
    ...
    */
    ...
    console.log('Hilomap config: cellSize=' + cellSize + ' radius=' + this.getRadius() + ' blur=' + this.getBlur() + ' pixelRatio=' + pixelRatio + ' zoomRatio=' + zoomRatio);
